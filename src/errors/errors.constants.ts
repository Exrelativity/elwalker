...
export const INVENTORY_NOT_FOUND = '500001: This inventory or service, Has not been added yet or Is not valid';

export const NO_SUCH_SERVICE = '500002: This Service list Does not Exit';

export const INVENTORY_EXIT = '500003: This inventory already exit please differentiate, thanks'

export const PRODUCT_NOT_FOUND = '500101: This product or service, Has not been added yet or Is not valid';

export const NO_SUCH_PRODUCT = '500102: This Service list Does not Exit';

export const PRODUCT_EXIT = '500103: This product already exit please differentiate, thanks'

export const BOOKING_NOT_FOUND = '500201: This booking or service, Has not been added yet or Is not valid';

export const BOOKING_EXIT = '500203: This booking already exit please differentiate, thanks'

export const ORDER_NOT_FOUND = '500301: This Order or service, Has not been added yet or Is not valid';

export const ORDER_EXIT = '500303: This Order already exit please differentiate, thanks'